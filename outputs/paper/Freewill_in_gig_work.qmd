...
```{r}
#| label: fig-descrip
#| fig-cap: Descriptive summary of Likert Scale Results
#| layout-ncol: 2
#| echo: false
#| warning: false
#| message: false
...
ggplot(data_freq, aes(x = Question, y = Percent, fill = factor(Response))) +
  ...
  labs(x = "Question", y = "Percentage", title = "Job Satisfaction (T1) Likert Scale Responses") +
  theme_minimal() +
...
ggplot(data2_freq, aes(x = Question, y = Percent, fill = factor(Response))) +
  geom_bar(stat = "identity") +
  scale_fill_brewer(palette = "Blues", name = "Response") +
  labs(x = "Question", y = "Percentage", title = "Job Satisfaction (T2) Likert Scale Responses") +
  theme_minimal() +
  theme(legend.position = "bottom")
```
